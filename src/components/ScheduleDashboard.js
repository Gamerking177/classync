    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 to-blue-300 p-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
        ...
        <Link
          ...
          className="flex flex-col items-center justify-center w-full h-48 md:h-56 bg-white rounded-xl shadow-lg border border-blue-200 transition-transform transform hover:scale-105 hover:shadow-2xl"
        >
